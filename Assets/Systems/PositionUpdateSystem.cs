...
public class PositionUpdateSystem : ISystem
{
    public void UpdateSystem()
    {
        ...
        World.ForEachElementWithTag(new List<string> { World.simulableTag, "dynamic" }, new List<string>{ "Velocity", "Position" }, (EntityComponent entity, List<IComponent> components) => {
        ...
        World.ForEachElementWithTag(new List<string> { World.simulableTag, "static" }, new List<string> { "Position" }, (EntityComponent entity, List<IComponent> components) => {
